...
export class ProductCardComponent {
                    ...
                    <div class="card equipment-card h-100" data-id="${data.id}" style="cursor: pointer;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-outline-secondary" id="edit-card-${data.id}" data-id="${data.id}">
                                    ✏️ Ред.
                                </button>
                                <button class="btn btn-outline-danger" id="delete-card-${data.id}" data-id="${data.id}">
                                    🗑️ Удалить
                                </button>
                            </div>
                        </div>
    ...
    addListeners(data, onDetailClick, onEditClick, onDeleteClick) {
        ...
        if (editButton) {
            editButton.addEventListener("click", (e) => {
                e.stopPropagation();
                if (onEditClick) onEditClick(data.id);
            });
        }
    ...
    render(data, onDetailClick, onEditClick, onDeleteClick) {
        ...
        this.addListeners(data, onDetailClick, onEditClick, onDeleteClick);
        setTimeout(() => {
